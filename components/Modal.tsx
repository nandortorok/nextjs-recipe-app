  ...
  return (
    ...
    >
      ...
      <Transition.Child
        ...
        leaveTo="opacity-0"
      >
        <Dialog.Panel className="w-full flex flex-col min-h-0 relative z-50 mx-auto max-w-[95vw] divide-y rounded-lg bg-white shadow-2xl md:max-w-3xl transition-opacity">
            {children}
        </Dialog.Panel>
      </Transition.Child>
    </Dialog>

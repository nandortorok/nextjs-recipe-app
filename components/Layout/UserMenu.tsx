...
const UserMenu = ({ children }: UserMenuProps) => {
  return (
    <>
      <Menu>
        <Menu.Button className="align-middle">{children}</Menu.Button>
        <Transition
          as={Fragment}
        ...
        >
          <Menu.Items className="absolute right-0 z-20 w-48 origin-top-right rounded-lg bg-white py-4 px-2 shadow-md">
            <Menu.Item>
              <button
